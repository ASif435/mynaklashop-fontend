...
const Cart = () => {
    ...
    const increaQty = (id,quantity,stock)=>{
                    ...
                    <div className="row">
                        ...
                        <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                            <div className="stockCounter d-inline">
                                ...
                                // onClick={()=>decreaQty(item.quantity,item.product)}
                                >-</span>
                                ...
                                //  onClick={()=>increaQty(item.quantity,item.product,item.stock)}
                                >+</span>
                            </div>
                        </div>
